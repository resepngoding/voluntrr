        ...
        <div class="row">
            <div class="col-lg-8 mx-auto">
                ...
                <div class="card mx-4 p-4">
                    <form wire:submit.prevent="updateDonation" autocomplete="off">
                        <div class="form-row">
                          ...
                          <div class="form-row" >
                            <div class="form-group col-md-6">
                              ...
                              <input  wire:model.defer="state.goods" type="text" class="form-control  @error('goods') is-invalid @enderror" id="inputGoods">
                              @error('goods')
                              <div class="invalid-feedback">
                              {{ $message }}
                              </div>
                            ...
                            <div class="form-group col-md-6">
                                <label for="inputGoodsQty">Jumlah Barang</label>
                                <input  wire:model.defer="state.goods_qty" type="text" class="form-control  @error('goods_qty') is-invalid @enderror" id="inputGoodsQty">
                                @error('goods_qty')
                                <div class="invalid-feedback">
                                {{ $message }}
                                </div>
                          ...
                          <div class="form-group">
                            ...
                            @if($photo)
                            <img style="width:30px" src="{{ $photo->temporaryUrl() }}" alt="">
                            @else
                            <img style="width:40px;max-width:300px" src="{{ asset('storage/transfer_images/' . $donation['image']) }}" alt="">
                            @endif
